...
module.exports = {
  ...
  https: {
    listenIp: process.env.MEDIASOUP_LISTEN_IP || "172.18.119.246",
  ...
  mediasoup: {
    ...
    webRtcTransportOptions: {
      listenIps: [
        {
          ip: process.env.MEDIASOUP_LISTEN_IP || "172.18.119.246",
          announcedIp: process.env.MEDIASOUP_ANNOUNCED_IP || "172.18.119.246",
        },
      ],
