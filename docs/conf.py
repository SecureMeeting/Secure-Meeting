...
htmlhelp_basename = 'Secure-Meeting'
...
man_pages = [
    ('index', 'Secure-Meeting', u'Secure-Meeting Documentation',
     [u'eternicode'], 1)
]
...
texinfo_documents = [
  ('index', 'Secure-Meeting', u'Secure-Meeting Documentation',
   u'eternicode', 'Secure-Meeting', 'One line description of project.',
   'Miscellaneous'),
]
